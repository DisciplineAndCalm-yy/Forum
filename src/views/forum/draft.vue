...
<template>
  <div class="draft">
    ...
    <div class="bgBox">
        ...
        <div class="userAction clearfix">
            ...
            <div class="actionBox fll mr80" @click="$router.push('/draft')">
                <span class="mr17 actionSeleted">草稿箱</span>
    ...
    <div class="total">
        <div class="content">
            <div v-for="(item, index) in forumData" :key="index" class="item clearfix">
                    ...
                    <div class="cl-bottom clearfix">
                        <div class="clb-left fll clearfix">
                            <div class="b-right fll clearfix">
                                ...
                                <div class="bbr fll" @click="$router.push('/detail')">
                                    <i>
                                    <img class="looknumImg" draggable="false" src="../../../static/imgs/forum/editor.png">
                                    </i>
                                    <span class="bbrFont">编辑</span>
                                </div>
                                <div class="bbr fll" @click="$router.push('/detail')">
                                    <i>
                                    <img class="likenumImg" draggable="false" src="../../../static/imgs/forum/transh.png">
                                    </i>
                                    <span class="bbrFont">删除</span>
                                </div>
                            </div>
                        </div>
